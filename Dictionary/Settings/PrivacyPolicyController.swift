...
final class PrivacyPolicyController: UIViewController {
    ...
    let policy = """
        ...
        Application means the software program provided by the Company downloaded by You on any electronic device, named Nonogram

        Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Nonogram.
        ...
        By email: aliyaumergalina@gmail.com
        """
    ...
    private func setupTextView() {
        ...
        policyTextView.isScrollEnabled = true
        policyTextView.font = .systemFont(ofSize: 13)
